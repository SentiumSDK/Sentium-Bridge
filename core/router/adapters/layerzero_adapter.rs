// REAL LayerZero Adapter - Omnichain interoperability protocol
...
pub struct RealLayerZeroAdapter {
    chain_name: String,
    http_provider: Arc<Provider<Http>>,
    translator: Arc<IntentTranslator>,
}

impl RealLayerZeroAdapter {
    pub async fn new(http_url: String, translator: Arc<IntentTranslator>) -> Result<Self, RouterError> {
        ...
        Ok(Self {
            chain_name: "layerzero".to_string(),
...
#[async_trait]
impl super::chain_adapter::ChainAdapter for RealLayerZeroAdapter {
    fn chain_name(&self) -> &str { &self.chain_name }
    fn chain_id(&self) -> &str { "layerzero-v2" }
